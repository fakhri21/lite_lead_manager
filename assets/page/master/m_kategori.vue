  ...
  module.exports = {
      ...
      return {
       ...
       //form
        ...
        //datatable
          fields:[
                  'index',
                        {key:'nama_kategori',label:'nama_kategori',sortable: true},
                  'actions',
                    ],
    ...
    methods: {
      ...
      addData(event) {
        ...
        axios.post(base_url + "m_kategori", params,config).then(function (response) {
      ...
      updateData() {
        ...
        var params = Qs.stringify(kirim)
        axios.put(base_url + "m_kategori", params,config).then(function (response) {
      ...
      deleteData(id) {
        ...
        .then((result) => {
          if (result.isConfirmed) {
            ...
            axios.delete(base_url + "m_kategori",config)
