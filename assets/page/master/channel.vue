  ...
  module.exports = {
    ...
    data: function () {
      return {
       ...
       //form
        formSchema: {
          fields: [
            
            {
              ...
              label: 'nama_channel',
              required:true,
              placeholder: 'Masukkan nama_channel'
            },
        ...
        //datatable
          fields:[
                        {key:'nama_channel',label:'nama_channel',sortable: true},
                  'actions',
                    ],
    ...
    methods: {
      ...
      addData(event) {
        ...
        axios.post(base_url + "channel", params,config).then(function (response) {
      ...
      updateData() {
        ...
        var params = Qs.stringify(kirim)
        axios.put(base_url + "channel", params,config).then(function (response) {
      ...
      deleteData(id) {
        ...
        .then((result) => {
          if (result.isConfirmed) {
            ...
            axios.delete(base_url + "channel",config)
