  ...
  module.exports = {
      ...
      return {
       ...
       //form
        formSchema: {
          fields: [
            ...
            
            {
              ...
              label: 'id_kategori',
              required:true,
              placeholder: 'Masukkan id_kategori'
            },
            
            {
              ...
              label: 'id_status',
              required:true,
              placeholder: 'Masukkan id_status'
            },
            ...
            
            {
              ...
              label: 'create_time',
              required:true,
              placeholder: 'Masukkan create_time'
            },
        ...
        //datatable
          fields:[
                  'index',
                        {key:'id_leads',label:'id_leads',sortable: true},
                        {key:'id_kategori',label:'id_kategori',sortable: true},
                        {key:'id_status',label:'id_status',sortable: true},
                        {key:'keterangan',label:'keterangan',sortable: true},
                        {key:'create_time',label:'create_time',sortable: true},
                  'actions',
                    ],
    ...
    methods: {
      ...
      showAll() {
        ...
        axios.get(base_url + "task_followup",config).then(function (response) {
